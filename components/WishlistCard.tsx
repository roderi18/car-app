...
const WishlistCard: React.FC<WishlistCardProps> = ({ name, image, numSolds, price, rating, onPress }) => {
    const { dark } = useTheme();
        ...
        >
            ...
            <View style={styles.favouriteContainer}>
                <TouchableOpacity onPress={onPress}>
                    <Image source={icons.heart5} resizeMode="contain" style={styles.heartIcon} />
                </TouchableOpacity>
            </View>
