        ...
        <SafeAreaView style={[styles.area, { backgroundColor: colors.background }]}>
            <View style={[styles.container, { backgroundColor: colors.background }]}>
                ...
                <View style={{ marginVertical: 22 }}>
                    <SocialButtonV2 title="Continuar con Facebook" icon={icons.facebook} onPress={() => navigate("signup")} />
                    <SocialButtonV2 title="Continuar con Google" icon={icons.google} onPress={() => navigate("signup")} />
                    <SocialButtonV2
